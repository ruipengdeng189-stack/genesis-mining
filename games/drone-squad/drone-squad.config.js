(function () {
    window.GENESIS_DRONE_SQUAD_CONFIG = {
        ...
        chapters: [
            ...
            { id: '1-3', name: { zh: '裂隙拦截', en: 'Rift Intercept' }, recommended: 620, reward: { credits: 340, alloy: 18, coreChips: 1, seasonXp: 28 }, chapter: 1, pressure: { zh: '首个精英挑战', en: 'First Elite Challenge' }, prep: { zh: '补火力与僚机', en: 'Add damage and wing' }, rewardFocus: { zh: '核心芯片', en: 'Core chip drop' } },
            ...
            { id: '3-2', name: { zh: '深域船坟', en: 'Deep Graveyard' }, recommended: 4500, reward: { credits: 1380, alloy: 60, coreChips: 4, seasonXp: 76 }, chapter: 3, pressure: { zh: '生存续航段', en: 'Sustain Stage' }, prep: { zh: '护盾研究+恢复僚机', en: 'Shield research + sustain' }, rewardFocus: { zh: '高阶合金', en: 'High alloy gain' } },
            { id: '3-3', name: { zh: '终端母巢', en: 'Terminal Hive' }, recommended: 6200, reward: { credits: 1760, alloy: 74, coreChips: 5, seasonXp: 92 }, chapter: 3, pressure: { zh: '终章双检定', en: 'Dual Check' }, prep: { zh: '爆发与续航都要够', en: 'Need burst and sustain' }, rewardFocus: { zh: '首轮毕业芯片', en: 'End-of-loop chips' } },
            ...
            { id: '4-3', name: { zh: '王冠裂界', en: 'Crown Break' }, recommended: 12900, reward: { credits: 3240, alloy: 126, coreChips: 10, seasonXp: 148 }, chapter: 4, pressure: { zh: '终局 Boss 战', en: 'Endgame Boss Stage' }, prep: { zh: '高星主机+Boss 增伤', en: 'High-star chassis + boss dmg' }, rewardFocus: { zh: '顶级芯片', en: 'Top-tier chips' } }
        ],
        upgradeCurves: {
