(function () {
    window.GENESIS_NEON_CARDS_CONFIG = {
        ...
        chapters: [
            { id: '1-1', name: { zh: '霓虹码头', en: 'Neon Dock' }, recommended: 280, chapter: 1, reward: { credits: 200, tactCores: 12, cipherChips: 0, seasonXp: 18 }, pressure: { zh: '前线抢节奏', en: 'Frontline Tempo' }, rewardFocus: { zh: '基础金币', en: 'Starter credits' } },
            { id: '1-2', name: { zh: '回路街区', en: 'Circuit Block' }, recommended: 380, chapter: 1, reward: { credits: 280, tactCores: 16, cipherChips: 0, seasonXp: 22 }, pressure: { zh: '能量节奏', en: 'Energy Timing' }, rewardFocus: { zh: '前期核心', en: 'Early cores' } },
            { id: '1-3', name: { zh: '信标争夺', en: 'Beacon Clash' }, recommended: 520, chapter: 1, reward: { credits: 380, tactCores: 20, cipherChips: 1, seasonXp: 28 }, pressure: { zh: '首个 Boss', en: 'First Boss' }, rewardFocus: { zh: '首个芯片', en: 'First chip' } },
            { id: '2-1', name: { zh: '裂隙广场', en: 'Fracture Plaza' }, recommended: 700, chapter: 2, reward: { credits: 520, tactCores: 28, cipherChips: 1, seasonXp: 36 }, pressure: { zh: '双路线压', en: 'Two-lane Pressure' }, rewardFocus: { zh: '核心产出', en: 'Core income' } },
            { id: '2-2', name: { zh: '低语回廊', en: 'Whisper Hall' }, recommended: 900, chapter: 2, reward: { credits: 690, tactCores: 34, cipherChips: 2, seasonXp: 42 }, pressure: { zh: '控制检定', en: 'Control Check' }, rewardFocus: { zh: '稀有成型', en: 'Rare setup' } },
            { id: '2-3', name: { zh: '镜像内城', en: 'Mirror Core' }, recommended: 1140, chapter: 2, reward: { credits: 900, tactCores: 42, cipherChips: 2, seasonXp: 50 }, pressure: { zh: '第二个 Boss', en: 'Second Boss' }, rewardFocus: { zh: '中期金币', en: 'Mid credits' } },
            { id: '3-1', name: { zh: '赤电线圈', en: 'Red Coil' }, recommended: 1420, chapter: 3, reward: { credits: 1180, tactCores: 54, cipherChips: 3, seasonXp: 62 }, pressure: { zh: '后排承压', en: 'Backline Pressure' }, rewardFocus: { zh: '更多芯片', en: 'More chips' } },
            { id: '3-2', name: { zh: '深层中继', en: 'Deep Relay' }, recommended: 1760, chapter: 3, reward: { credits: 1490, tactCores: 66, cipherChips: 4, seasonXp: 76 }, pressure: { zh: '研究门槛', en: 'Research Gate' }, rewardFocus: { zh: '后期核心', en: 'Late cores' } },
            { id: '3-3', name: { zh: '穹顶主板', en: 'Dome Mainframe' }, recommended: 2140, chapter: 3, reward: { credits: 1880, tactCores: 82, cipherChips: 5, seasonXp: 92 }, pressure: { zh: '史诗检定', en: 'Epic Check' }, rewardFocus: { zh: '史诗成型', en: 'Epic setup' } },
            { id: '4-1', name: { zh: '零区突围', en: 'Zero District' }, recommended: 2540, chapter: 4, reward: { credits: 2280, tactCores: 96, cipherChips: 6, seasonXp: 108 }, pressure: { zh: '高压快攻', en: 'Heavy Tempo' }, rewardFocus: { zh: '后期金币', en: 'Late credits' } },
            { id: '4-2', name: { zh: '湮灭界桥', en: 'Null Bridge' }, recommended: 2920, chapter: 4, reward: { credits: 2740, tactCores: 112, cipherChips: 8, seasonXp: 126 }, pressure: { zh: '4星门槛', en: '4-Star Gate' }, rewardFocus: { zh: '高阶芯片', en: 'High chips' } },
            { id: '4-3', name: { zh: '冠冕中枢', en: 'Crown Nexus' }, recommended: 3320, chapter: 4, reward: { credits: 3360, tactCores: 132, cipherChips: 10, seasonXp: 148 }, pressure: { zh: '终局 Boss', en: 'Final Boss' }, rewardFocus: { zh: '精英卡包', en: 'Elite crate' } }
        ],
        research: [
        ...
        paymentOffers: [
            ...
            { id: 'captain', price: 30, name: { zh: '队长培养包', en: 'Captain Growth Pack' }, reward: { credits: 21000, tactCores: 780, cipherChips: 48, eliteCrates: 2, cardFragments: { marshalZero: 18, aegisNova: 18, voltFox: 18 } }, permanent: { zh: '领袖技充能 +6%', en: 'Leader skill charge +6%' } },
