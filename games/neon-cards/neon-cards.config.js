(function () {
    window.GENESIS_NEON_CARDS_CONFIG = {
        meta: {
            ...
            subtitle: { zh: '三路实时卡战、拖放出牌、卡组养成与赛季成长', en: 'Tri-lane live card battle with deck growth and season progression' }
        },
        tabs: [
        ...
        leaders: [
            {
                ...
                skill: { zh: '全路单位短时过载，攻速与攻击提高。', en: 'Temporarily overclocks all lanes for more attack and fire rate.' },
            ...
            },
            {
                ...
                role: { zh: '护盾生存', en: 'Shield sustain' },
                skill: { zh: '给全场友军补护盾并抬高前排续航。', en: 'Adds shields to your board and improves frontline survival.' },
            ...
            },
            {
                ...
                skill: { zh: '单路爆发清线，更适合快攻压制。', en: 'A single-lane burst skill built for tempo pressure.' },
        ...
        units: [
            {
                ...
                role: { zh: '2 费快攻前压', en: '2-cost tempo pressure' },
                lane: 'front',
                cost: 2,
            ...
            },
            {
                ...
                role: { zh: '3 费前排承伤', en: '3-cost frontline tank' },
                lane: 'front',
                cost: 3,
            ...
            },
            {
                ...
                role: { zh: '3 费远程稳伤', en: '3-cost stable ranged DPS' },
                lane: 'back',
                cost: 3,
            ...
            },
            {
                ...
                role: { zh: '2 费续航辅助', en: '2-cost sustain support' },
                lane: 'support',
                cost: 2,
            ...
            },
            {
                ...
                role: { zh: '4 费 Boss 点杀', en: '4-cost boss burst' },
                lane: 'back',
                cost: 4,
            ...
            {
                id: 'chainBrute',
                name: { zh: '链锤巨汉', en: 'Chain Brute' },
                role: { zh: '4 费群伤前排', en: '4-cost splash frontline' },
                lane: 'front',
                cost: 4,
        ...
        chapters: [
            { id: '1-1', name: { zh: '霓虹码头', en: 'Neon Dock' }, recommended: 240, chapter: 1, reward: { credits: 200, tactCores: 12, cipherChips: 0, seasonXp: 18 }, pressure: { zh: '抢前线', en: 'Frontline Tempo' }, rewardFocus: { zh: '基础金币', en: 'Starter credits' } },
            ...
            { id: '2-1', name: { zh: '裂隙广场', en: 'Fracture Plaza' }, recommended: 1040, chapter: 2, reward: { credits: 520, tactCores: 28, cipherChips: 1, seasonXp: 36 }, pressure: { zh: '双路压线', en: 'Two-lane Pressure' }, rewardFocus: { zh: '战术核心', en: 'Core income' } },
            { id: '2-2', name: { zh: '低语回廊', en: 'Whisper Hall' }, recommended: 1560, chapter: 2, reward: { credits: 690, tactCores: 34, cipherChips: 2, seasonXp: 42 }, pressure: { zh: '控制检定', en: 'Control Check' }, rewardFocus: { zh: '稀有卡成型', en: 'Rare setup' } },
            ...
            { id: '3-3', name: { zh: '穹顶主板', en: 'Dome Mainframe' }, recommended: 6460, chapter: 3, reward: { credits: 1880, tactCores: 82, cipherChips: 5, seasonXp: 92 }, pressure: { zh: '史诗检定', en: 'Epic Check' }, rewardFocus: { zh: '史诗保底前置', en: 'Epic setup' } },
            ...
            { id: '4-2', name: { zh: '湮灭界桥', en: 'Null Bridge' }, recommended: 10680, chapter: 4, reward: { credits: 2740, tactCores: 112, cipherChips: 8, seasonXp: 126 }, pressure: { zh: '4★ 门槛', en: '4-Star Gate' }, rewardFocus: { zh: '高阶芯片', en: 'High chips' } },
        ...
        research: [
            { id: 'energyMatrix', name: { zh: '能量矩阵', en: 'Energy Matrix' }, desc: { zh: '提高能量恢复，并在关键等级提升能量上限。', en: 'Improves energy regeneration and raises max energy at breakpoints.' }, maxLevel: 12, baseCredits: 120, baseChips: 2, effect: { zh: '能量恢复 +2%', en: 'Energy regen +2%' } },
            { id: 'frontlineArmor', name: { zh: '前线装甲', en: 'Frontline Armor' }, desc: { zh: '提高前排生命和护盾能力。', en: 'Raises frontline HP and shield durability.' }, maxLevel: 12, baseCredits: 120, baseChips: 2, effect: { zh: '前排生存 +4%', en: 'Frontline survival +4%' } },
            { id: 'fireControl', name: { zh: '火控校准', en: 'Fire Control' }, desc: { zh: '提高后排与远程单位输出。', en: 'Increases ranged and backline damage.' }, maxLevel: 15, baseCredits: 140, baseChips: 3, effect: { zh: '远程攻击 +3.5%', en: 'Ranged damage +3.5%' } },
            ...
            { id: 'bountyRelay', name: { zh: '悬赏中继', en: 'Bounty Relay' }, desc: { zh: '提高章节金币和核心收益。', en: 'Improves chapter credits and tact core income.' }, maxLevel: 10, baseCredits: 160, baseChips: 3, effect: { zh: '收益 +3%', en: 'Yield +3%' } }
        ],
        missions: [
            ...
            { id: 'm3', title: { zh: '开 2 个标准包', en: 'Open 2 Standard Crates' }, metric: 'cratesOpened', target: 2, reward: { credits: 420, tactCores: 24 } },
        ...
        paymentOffers: [
            { id: 'starter', price: 6, name: { zh: '新手编组包', en: 'Starter Deck Pack' }, reward: { credits: 3000, tactCores: 120, cipherChips: 8, eliteCrates: 1 }, permanent: { zh: '能量恢复 +3%', en: 'Energy regen +3%' } },
