(function () {
    window.IRON_FRONTIER_CONFIG = {
        meta: {
            ...
            eyebrow: { zh: 'GENESIS · IRON FRONTIER', en: 'GENESIS · IRON FRONTIER' },
            accent: '#ffb357'
        },
        tabs: [
            { id: 'run', icon: '▶', label: { zh: '战区', en: 'Run' } },
            { id: 'train', icon: '▣', label: { zh: '整备', en: 'Train' } },
            { id: 'crew', icon: '☷', label: { zh: '乘员', en: 'Crew' } },
            { id: 'workshop', icon: '✦', label: { zh: '研发', en: 'Workshop' } },
            { id: 'missions', icon: '✓', label: { zh: '任务', en: 'Missions' } },
            { id: 'season', icon: '⌁', label: { zh: '赛季', en: 'Season' } },
            { id: 'shop', icon: '◎', label: { zh: '商店', en: 'Shop' } }
        ],
        resources: [
        ...
        modules: [
            ...
            { id: 'mainGun', icon: '✦', maxLevel: 8, name: { zh: '主炮车', en: 'Main Gun' }, summary: { zh: '主输出、清怪、Boss 压制', en: 'Primary damage, wave clear, boss pressure' }, effect: { zh: '伤害 +11% / Boss 伤害 +2%', en: 'Damage +11% / Boss damage +2%' } },
            ...
            { id: 'supportCar', icon: '✚', maxLevel: 6, name: { zh: '支援车', en: 'Support Car' }, summary: { zh: '维修、冷却、回收支撑', en: 'Repair, cooldown, salvage support' }, effect: { zh: '修复 +8% / 冷却 -1.5%', en: 'Repair +8% / Cooldown -1.5%' } },
            { id: 'ultimate', icon: '◎', maxLevel: 5, name: { zh: '轨炮', en: 'Rail Burst' }, summary: { zh: '清场、破段、紧急翻盘', en: 'Clear waves, break bosses, emergency swing' }, effect: { zh: '直伤 +15% / 充能 -4%', en: 'Burst +15% / Charge -4%' } }
        ],
        moduleUpgradeTables: {
        ...
        crew: [
            { id: 'mira', icon: 'M', maxLevel: 6, name: { zh: '米拉', en: 'Mira' }, role: { zh: '列车长', en: 'Conductor' }, summary: { zh: '推进效率与事件收益', en: 'Route pace and event value' }, passive: { zh: '路线选择收益 +6%', en: 'Route choice value +6%' } },
            { id: 'knox', icon: 'K', maxLevel: 6, name: { zh: '诺克斯', en: 'Knox' }, role: { zh: '炮手', en: 'Gunner' }, summary: { zh: '主炮伤害与超载爆发', en: 'Main gun damage and overdrive burst' }, passive: { zh: '超载期间伤害 +8%', en: 'Overdrive damage +8%' } },
            { id: 'lio', icon: 'L', maxLevel: 6, name: { zh: '里奥', en: 'Lio' }, role: { zh: '机修师', en: 'Mechanic' }, summary: { zh: '维修、冷却与过热控制', en: 'Repair, cooldown and heat control' }, passive: { zh: '维修额外恢复 +6%', en: 'Repair restores +6%' } },
            { id: 'ves', icon: 'V', maxLevel: 6, name: { zh: '维斯', en: 'Vess' }, role: { zh: '侦察员', en: 'Scout' }, summary: { zh: '精英预警与波次节奏', en: 'Elite warning and wave rhythm' }, passive: { zh: '精英预警更早出现', en: 'Elite warnings appear earlier' } },
            { id: 'suri', icon: 'S', maxLevel: 6, name: { zh: '苏芮', en: 'Suri' }, role: { zh: '回收员', en: 'Scavenger' }, summary: { zh: '废钢回收与结算加成', en: 'Scrap salvage and payout boost' }, passive: { zh: '废钢收益 +7%', en: 'Scrap gain +7%' } }
        ],
        research: [
            ...
            { id: 'repairGrid', icon: '✚', maxLevel: 10, name: { zh: '维修网格', en: 'Repair Grid' }, effect: { zh: '修复效率 +4%', en: 'Repair +4%' }, baseCost: { scrap: 130, fuelCells: 9, coreChips: 1 } },
            { id: 'salvageCharter', icon: '◈', maxLevel: 8, name: { zh: '回收章程', en: 'Salvage Charter' }, effect: { zh: '废钢 / 燃料收益 +3%', en: 'Scrap / Fuel +3%' }, baseCost: { scrap: 160, fuelCells: 12, coreChips: 1 } },
        ...
        stages: [
            ...
            { id: '1-3', chapter: 1, type: 'normal', name: { zh: '灰烬仓栈', en: 'Ash Depot' }, recommended: 360, reward: { scrap: 140, fuelCells: 12, coreChips: 1, relayData: 0, seasonXp: 16 }, pressure: { zh: '维修时机检定', en: 'Repair timing check' }, rewardFocus: { zh: '第一片芯片', en: 'First chip' } },
            { id: '1-4', chapter: 1, type: 'normal', name: { zh: '锈谷险道', en: 'Rust Gorge' }, recommended: 520, reward: { scrap: 180, fuelCells: 16, coreChips: 1, relayData: 0, seasonXp: 20 }, pressure: { zh: '连续压迫', en: 'Sustained pressure' }, rewardFocus: { zh: '中期整备起点', en: 'Prep ramp-up' } },
            ...
            { id: '1-6', chapter: 1, type: 'boss', name: { zh: '灼痕枢纽', en: 'Scorch Nexus' }, recommended: 920, reward: { scrap: 310, fuelCells: 26, coreChips: 3, relayData: 1, seasonXp: 30 }, pressure: { zh: '首个 Boss', en: 'First boss' }, rewardFocus: { zh: '终极技能时机', en: 'Ultimate timing' } },
            { id: '2-1', chapter: 2, type: 'normal', name: { zh: '铁泥站场', en: 'Ironmud Yard' }, recommended: 1180, reward: { scrap: 380, fuelCells: 30, coreChips: 3, relayData: 0, seasonXp: 34 }, pressure: { zh: '双路线取舍', en: 'Dual route choice' }, rewardFocus: { zh: '废钢提速', en: 'Scrap pace' } },
            { id: '2-2', chapter: 2, type: 'normal', name: { zh: '裂隙隧道', en: 'Fracture Tunnel' }, recommended: 1480, reward: { scrap: 460, fuelCells: 36, coreChips: 4, relayData: 0, seasonXp: 40 }, pressure: { zh: '护盾续航', en: 'Shield uptime' }, rewardFocus: { zh: '燃料循环', en: 'Fuel loop' } },
            { id: '2-3', chapter: 2, type: 'normal', name: { zh: '熔炉脊线', en: 'Furnace Ridge' }, recommended: 1840, reward: { scrap: 560, fuelCells: 42, coreChips: 5, relayData: 1, seasonXp: 46 }, pressure: { zh: '主炮 / 研发双检定', en: 'Gun / lab double check' }, rewardFocus: { zh: '主炮成型', en: 'Gun shaping' } },
            { id: '2-4', chapter: 2, type: 'normal', name: { zh: '积水岔口', en: 'Flood Switch' }, recommended: 2280, reward: { scrap: 680, fuelCells: 50, coreChips: 6, relayData: 1, seasonXp: 54 }, pressure: { zh: '事件取舍', en: 'Event tradeoff' }, rewardFocus: { zh: '研究补齐', en: 'Lab catch-up' } },
            ...
            { id: '2-6', chapter: 2, type: 'boss', name: { zh: '废钢堡垒', en: 'Scrap Bastion' }, recommended: 3480, reward: { scrap: 990, fuelCells: 72, coreChips: 8, relayData: 2, seasonXp: 76 }, pressure: { zh: '持久战 Boss', en: 'Attrition boss' }, rewardFocus: { zh: '中继起量', en: 'Relay start' } },
            { id: '3-1', chapter: 3, type: 'normal', name: { zh: '静电脉冲口', en: 'Static Mouth' }, recommended: 4260, reward: { scrap: 1200, fuelCells: 84, coreChips: 10, relayData: 1, seasonXp: 88 }, pressure: { zh: '高热管理', en: 'Heat management' }, rewardFocus: { zh: '芯片增量', en: 'Chip ramp' } },
            ...
            { id: '3-5', chapter: 3, type: 'elite', name: { zh: '核心峡谷', en: 'Core Canyon' }, recommended: 9240, reward: { scrap: 2560, fuelCells: 164, coreChips: 18, relayData: 2, seasonXp: 156 }, pressure: { zh: '精英连段', en: 'Elite chain' }, rewardFocus: { zh: '研究补全', en: 'Research fill' } },
            ...
            { id: '4-1', chapter: 4, type: 'normal', name: { zh: '黑轨裂口', en: 'Blackrail Breach' }, recommended: 13460, reward: { scrap: 3720, fuelCells: 232, coreChips: 24, relayData: 2, seasonXp: 206 }, pressure: { zh: '后期波次密度', en: 'Late wave density' }, rewardFocus: { zh: '终章起量', en: 'Final arc start' } },
        ...
        missions: [
            ...
            { id: 'm2', metric: 'wins', target: 1, title: { zh: '通过 1 个关卡', en: 'Clear 1 Stage' }, reward: { scrap: 420, fuelCells: 24, coreChips: 2 } },
            ...
            { id: 'm5', metric: 'researchUpgrades', target: 3, title: { zh: '升级 3 次研发', en: 'Upgrade Research 3 Times' }, reward: { scrap: 760, fuelCells: 42, coreChips: 4, relayData: 1 } },
        ...
        bundles: [
            ...
            { id: 'frontier', price: 128, exactPrice: '128.00 USDT', title: { zh: '远境总控包', en: 'Far Frontier Pack' }, reward: { scrap: 42000, fuelCells: 2480, coreChips: 168, relayData: 18 }, permanent: { zh: '全局成长 +8% · 中继结算 +10%', en: 'Global growth +8% · Relay payout +10%' }, permanentBonus: { globalGrowth: 0.08, relayPayout: 0.1 } }
        ],
        battleEvents: [
            {
                id: 'station',
                ...
                options: [
                    { id: 'station-salvage', label: { zh: '回收物资', en: 'Salvage Crates' }, result: { zh: '立刻获得额外废钢，并提升本局回收收益。', en: 'Gain scrap now and improve this run salvage.' }, bonusReward: { scrap: 120 }, salvageBoost: 0.12 },
                    { id: 'station-repair', label: { zh: '快速维修', en: 'Quick Repair' }, result: { zh: '恢复车体与护盾。', en: 'Recover integrity and shield.' }, integrity: 14, shield: 20 }
                ]
            },
            {
                id: 'relay',
                ...
                options: [
                    ...
                    { id: 'relay-safe', label: { zh: '稳态推进', en: 'Steady Route' }, result: { zh: '保持稳定，并回复少量热量。', en: 'Stay stable and cool down.' }, progress: 6, heat: -10 }
                ]
            },
            {
                id: 'merchant',
                ...
                options: [
                    { id: 'merchant-battery', label: { zh: '换能电池', en: 'Swap Batteries' }, result: { zh: '提升终极充能。', en: 'Boost ultimate charge.' }, progress: 8, chargeBoost: 0.12 },
