(function () {
    ...
    function mapPaymentApiError(errorMessage) {
        ...
        if (lower.includes('minerid does not match order')) return getLocalized({ zh: '当前订单与本地账号不匹配，请重新创建订单。', en: 'This order does not belong to the current player. Please create a new order.' });
